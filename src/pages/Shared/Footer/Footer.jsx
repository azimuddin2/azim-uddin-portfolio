    ...
    return (
        <footer className="pt-12 lg:pt-20 px-6 lg:px-0 mt-12 lg:mt-16 bg-warning">
            <div className='footer max-w-screen-xl lg:mx-auto pb-8 border-b border-info'>
                <div>
                    <h2 className='text-primary font-semibold text-lg'>MD. AZIM UDDIN</h2>
                ...
                <div>
                    ...
                    <Link to="/services" className="link link-hover text-accent font-medium link-primary">Dev Track</Link>
                ...
                <div>
                    <span className="text-secondary font-bold text-lg mb-2">Software Development Track</span>
            ...
            <p className='text-center text-accent py-6'><small>Copyright © 2025 - MD. AZIM UDDIN</small></p>
            <ScrollToTop
                smooth
