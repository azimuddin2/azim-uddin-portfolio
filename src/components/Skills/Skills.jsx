...
import restAPI from '../../assets/skills/api.png';
    ...
    return (
        <section className="max-w-screen-xl lg:mx-auto mx-5 my-6 lg:my-12">
            <div className="text-center">
                ...
                <h1 className="text-2xl lg:text-3xl font-medium text-secondary">Technology Skills & Tools</h1>
            </div>
            <div className='mt-8 hidden lg:flex align-items-center items-center justify-evenly'>
                ...
                <ul className="timeline timeline-vertical">
                    ...
                    <li>
                        <hr className='bg-info' />
                        <div className="timeline-start timeline-box border-info bg-success">
                            <img src={redux} alt="Redux" className='w-8' />
                ...
                <ul className="timeline timeline-vertical">
                    ...
                    <li>
                        <hr className='bg-info' />
                        <div className="timeline-start timeline-box border-info bg-success">
                            <img src={restAPI} alt="Rest API" className='w-8' />
                ...
                <ul className="timeline timeline-vertical">
                    ...
                    <li>
                        ...
                        <div className="timeline-end timeline-box border-info bg-success">
                            <img src={postman} alt="Netlify" className='w-8' />
                            <span className='text-accent'>Postman</span>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div className='lg:hidden mt-6'>
                <ul className="timeline timeline-vertical">
                    ...
                    <li>
                        ...
                        <div className="timeline-end timeline-box border-info bg-success">
                            <img src={postman} alt="Postman" className='w-8' />
                            <span className='text-accent'>Postman</span>
                        </div>
                    </li>
                </ul>
